...
// Support Portal: [Login to Support Portal] XXXX
  ...
  return (
    <div className="relative z-10 rounded-sm bg-gray-100 p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
       Customer Support:
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
      Already a TopSalesWeb user and need assistance? Our support team is here to help with any issues or questions you may have.
      </p>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
       Email: support@topsalesweb.com   
      </p>
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
       <Link href="/signin" className="underline font-semibold">
         Support Portal: Login to Support Portal
       </Link>
...
export default NewsLatterBoxPartThree;
