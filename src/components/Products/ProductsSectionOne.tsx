     ...
     <div className="container">
      <div className="-mx-4 flex px-6 py-8 flex-wrap">
       ...
       <div className="w-full lg:w-6/12 px-4 pb-5 ">
            ...
            >
              <Image
                src="/images/crm/coach-speaking.avif"
                alt="about image"
                fill
        ...
        <div className="w-full lg:w-6/12 px-4 lg:py-24 lg:pb-4">
          <div className="mx-auto max-w-[800px] text-center">
            ...
            At TopSalesWeb, we offer a suite of CRM tools designed to meet the diverse needs of businesses, from startups to large enterprises. Our products are built to help you manage your client relationships with ease, streamline your sales process, and drive growth. Explore the features that make TopSalesWeb the ultimate CRM solution.
            </p>
